...
<div class="card">
  <div class="card-body">
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Ajouter une table</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <label for="recipient-name" class="col-form-label">béneficiare:</label>
          <input type="text" wire:model="user_name" class="form-control" id="recipient-name">
        </div>
            @error('user_name')
            ...
            <div class="form-group">
                <label for="recipient-name" class="col-form-label">motif:</label>
                  <input type="text" wire:model="motif" class="form-control" id="recipient-name">
                </div>
                    @error('motif')
                        <span class="text-danger">{{$message}}</span>
                    @enderror
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">motant:</label>
                          <input type="text" wire:model="montant" class="form-control" id="recipient-name">
                        </div>
                            @error('motif')
                                <span class="text-danger">{{$message}}</span>
                            @enderror
